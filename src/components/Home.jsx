  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow pt-20">
        ...
        <div id="about" className="relative h-screen flex justify-center items-center">
            {/* Video de fondo */}
            <video
            className="absolute top-0 left-0 w-full h-full object-cover"
            autoPlay
            ...
            muted
            >
            <source src="/videos/gamer.mp4" type="video/mp4" />
            Your browser does not support the video tag.
          </video>
          {/* Contenido superpuesto */}
          <div className="relative z-10 text-center text-white p-4">
            ...
            <p className="mt-4">
              Soy un desarrollador apasionado por el aprendizaje y los desafíos.
            </p>
            {/* Filtro oscuro opcional */}
            <div className="absolute top-0 left-0 w-full h-full bg-black opacity-50 z-0"></div>
          </div>
        ...
        <div id="projects" className="relative h-screen flex justify-center items-center">
            ...
            muted
            >
            <source src="/videos/Proyectos.mp4" type="video/mp4" />
            Your browser does not support the video tag.
          </video>
          {/* Contenido superpuesto */}
          <div className="relative z-10 text-center text-white p-4">
